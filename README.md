...
2. [Регистрация на хостинге и создание выделенного сервера SprintBOX](#ргистрация-на-хостинге-и-создание-выделенного-сервера-sprintbox)

3. [Регистрация бота в Telegram](#регистрация-бота-в-telegram)
...
1. Перейдите в личный кабинет OpenAI и нажмите на вкладку Personal в правом верхнем углу. В выпадающем списке выберите API keys.
   ![Гденайти api-ключ openai](./assets/op-ai-ken-get1.png)
